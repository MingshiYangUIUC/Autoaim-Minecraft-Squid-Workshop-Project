...
#tellraw @s[tag=aadebugv] [{"text":"Vx0: "},{"score":{"name":"Var","objective":"AutoAim_Vx0"}}]
#tellraw @s[tag=aadebugv] [{"text":"Vy0: "},{"score":{"name":"Var","objective":"AutoAim_Vy0"}}]
#tellraw @s[tag=aadebugv] [{"text":"Vz0: "},{"score":{"name":"Var","objective":"AutoAim_Vz0"}}]
...
tellraw @a[tag=aadebug,tag=aasuc] [{"score":{"name":"Var","objective":"AutoAim_Tim"}}]
tellraw @a[tag=aadebug,tag=aasuc] [{"score":{"name":"Var","objective":"AutoAim_Ang"}}]
#tellraw @a[tag=aadebug] [{"score":{"name":"Var","objective":"AutoAim_Rpos"}}]
