...
execute at @s run scoreboard players operation @s AutoAim_x += @s AutoAim_dx
execute at @s run scoreboard players operation @s AutoAim_y += @s AutoAim_dy
execute at @s run scoreboard players operation @s AutoAim_z += @s AutoAim_dz
